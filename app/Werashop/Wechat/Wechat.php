        ...
        return function ($event) {
            ...
            if ($customer) {
                ...
                elseif ($eventKey == 'qrscene_47711') {
                    return Message::make('text')->content("感谢您关注易康伴侣微信公众号。由中美健康峰会举办的2016年联合国糖尿病日 “移动关爱糖尿病”线上主题公益活动正在火热进行中，点击链接并进行简单注册，即可免费获得糖友礼品包，每人限领取一次，礼品数量有限，发完为止，快去注册吧！<a target=\"_blank\" href=\"http://www.baidu.com/\">前往领取礼品</a>\n<在这里您还可以学习糖尿病健康知识，赚取积分领取丰富奖品，欢迎体验>");
                }
                else {
