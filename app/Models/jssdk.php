...
class JSSDK {
  ...
  private function getJsApiTicket() {
    ...
    $data = json_decode(file_get_contents("/home/wwwroot/www.ohmate.cn/ohmate-shop/jsapi_ticket.json"));
    if ($data->expire_time < time() ) {
      ...
      if ($ticket) {
        ...
        $fp = fopen("/home/wwwroot/www.ohmate.cn/ohmate-shop/jsapi_ticket.json", "w");
  ...
  public function returnAccessToken () {
	  $returnaccesstoken = $this->getAccessToken();
