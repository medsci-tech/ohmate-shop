...
class CreateEnterpriseStatisticsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('enterprise_statistics', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::table('enterprise_statistics', function (Blueprint $table) {
            $table->dropForeign('enterprise_statistics_customer_id_foreign');
        });
        Schema::drop('enterprise_statistics');
    }
}
