    ...
    <div class="row">
      <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
          <li :class="(searching.user_type == '未兑换卡券')?'active':''" @click="choose_data" id="unfilled"><a href="#unfilled">未兑换卡券</a></li>
          <li :class="(searching.user_type == '已兑换卡券')?'active':''" @click="choose_data" id="filled"><a href="#filled">已兑换卡券</a></li>
          <li :class="(searching.user_type == '所有卡券')?'active':''" @click="choose_data" id="all"><a href="#all">所有订单</a></li>
        </ul>
      </div>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tr>
              ...
              <th>购买时间</th>
              <th>
                <button class="button button-small button-action">添加卡券</button>
              </th>
            </tr>
            </thead>
            <tbody>
